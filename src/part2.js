...
<>
 ...
 {tab2.map((valued,key)=>{
    return(   
        <> 
        <tr >
            <td><input  value= {valued.coursename} ref = {courseRef2} onKeyDown={handler}  onChange={(e)=> valued.course= e.target.value}  autoFocus ={valued.confirm} /></td>
            <td><input  value= {valued.courseload}  ref={courseloadRef2} onKeyDown={handler}  onChange={(e)=> valued.courseload= e.target.value} /></td>
            <td><input value = {valued.test} ref = {testRef2} type= {valued.type} onKeyDown={handler} onChange = {(e)=>valued.test= e.target.value} /></td>
            <td><input value = {valued.exam} ref = {examRef2} type= {valued.type}  onChange={calms}  onKeyDown={handler}/></td>
